<?php
  ...
  if(isset($_POST["action"], $_POST["duration"], $_POST["matricule"], $_POST["timetable"], $_POST["zone"], $_POST["email"])) {
      ...
      case "interieur":
        ...
        $prestation = $manager->getAll("
          ...
          WHERE indoorparking.minMass < ?
            ...
            AND category.base = ?
          LIMIT 1
        ", [$plane[0]["mass"] / 1000, $plane[0]["mass"] / 1000, $plane[0]["surface"], $plane[0]["surface"], $_POST["timetable"], $plane[0]["base"]]);
